...
/**
 * Clase ParserFileIni.
 * Parsea un Archivo tipo Ini y retorna un Objeto.
 *
 * @copyright   http://codeaid.net/php/parse-ini-file-into-a-multi-dimensional-array
 * @license     Creative Commons Attribution 3.0 Unported License.
 *              http://creativecommons.org/licenses/by/3.0/legalcode
 * @author      codeaid.net
 * @since       Este codigo fue extraido de internet bajo la licencia que se detalla,
 *              solo le hicimos cambios en los comentarios al Español y algun
 *              pequeñiso detalle en el codigo.
 * =============================================================================
 * TRADUCCION DE COMENTARIOS ORIGINALES AL ESPAÑOL.
 * =============================================================================
 * Parsea arcivos Ini a Arreglos Multidimencionales, Nosotros lo cambiaremos a objetos.
 * El parseador nativo de php la funcion parse_ini_file() convierte un archivo ini
 ...
 *   'debug.enabled' => 1
 * 
 * Esta clase permite parsear el archivo ini en un arreglo multidimensional
...
class ParserFileIni
{
        ...
        /**
         * Matriz de almacenamiento interno.
         * @var array
         */
